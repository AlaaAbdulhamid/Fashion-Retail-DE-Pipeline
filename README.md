# 🛠️ Fashion Retail | End-to-End Data Engineering Pipeline
...
1. Clone the repo:
    ...
    ```bash
    git clone https://github.com/AlaaAbdulhamid/Fashion-Retail-DE-Pipeline.git
    cd Fashion-Retail-DE-Pipeline
    ```
